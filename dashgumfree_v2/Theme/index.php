  ...
  <section id="container" >
      ...
      <header class="header black-bg">
            ...
            <div class="top-menu">
            	<ul class="nav pull-right top-menu">
                    <li><a class="logout" href="login.php">Cerrar</a></li>
            	</ul>
            </div>
        </header>
      <!--header end-->
	...
	<script type="text/javascript">
        ...
        var unique_id = $.gritter.add({
            ...
            title: 'Bienvenido al Sistema ICE!',
            // (string | mandatory) the text inside the notification
            text: 'Este sistema se encarga de gestionar los Usuarios y los Clientes de Coca Cola Femsa, haz click aqui si quieres <a href="crear_usuario.php" target="_blank" style="color:#ffd777">Crear Nuevo Usuario</a>.',
