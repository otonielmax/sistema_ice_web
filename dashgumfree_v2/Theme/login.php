		        ...
		        <div class="login-wrap">
		            ...
		            <label class="checkbox">
		                <span class="pull-right">
		                    <a data-toggle="modal" href="login.html#myModal"> ¿Olvidastes tu clave?</a>
		              ...
		              <div class="modal-dialog">
		                  <div class="modal-content">
		                      <div class="modal-header">
		                          ...
		                          <h4 class="modal-title">¿Olvidastes tu clave?</h4>
		                      </div>
		                      <div class="modal-body">
		                          <p>Ingresa tu correo para restablecer tu clave.</p>
		                          <input type="text" name="email_restore" placeholder="Correo" autocomplete="off" class="form-control placeholder-no-fix">
